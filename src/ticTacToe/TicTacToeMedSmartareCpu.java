...
public class TicTacToeMedSmartareCpu {
	...
	// allt från en av vinstlistorna så printas det ut vem som vann. Om brädet är
	// fullt men ingen har vunnit så
	...
	// metod för att placera spelarens val. Beroende på vems tur det är så placeras
	// rätt symbol ut på den valda positionen på brädet.
